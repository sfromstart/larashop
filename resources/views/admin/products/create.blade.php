                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="short_description" id="short_description" rows="2"
                                      class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-slate-500 focus:border-slate-500 text-sm"
                                      placeholder="상품 목록에 표시될 짧은 설명">{{ old('short_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="8"
                                      class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-slate-500 focus:border-slate-500 text-sm"
                                      placeholder="상품 상세 설명을 입력하세요">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">최대 10개 이미지, 각 5MB 이하. 첫 번째 이미지가 대표 이미지로 설정됩니다.</p>
                            </div>
                            <input type="hidden" name="primary_image_index" x-model="primaryImageIndex">

                            {{-- Preview --}}
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3" x-show="imagePreview.length > 0">
                                <template x-for="(img, index) in imagePreview" :key="index">
                                    <div class="relative group cursor-pointer rounded-lg overflow-hidden border-2 transition-colors"
                                         :class="primaryImageIndex === index ? 'border-blue-500' : 'border-gray-200'"
                                        ...
                                        <span x-show="primaryImageIndex === index"
                                              class="absolute top-1 left-1 px-1.5 py-0.5 text-xs font-medium bg-blue-500 text-white rounded">
                                            대표
                                        </span>
                                    </div>
                                </template>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        <template x-if="options.length === 0">
                            <p class="text-sm text-gray-500 text-center py-4">등록된 옵션이 없습니다. 옵션 추가 버튼을 클릭하세요.</p>
                        </template>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="compare_price" id="compare_price" value="{{ old('compare_price') }}" min="0"
                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-slate-500 focus:border-slate-500 text-sm pr-8">
                                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-gray-400">원</span>
                            </div>
                            @error('compare_price')
